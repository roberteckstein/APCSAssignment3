...
public class MinerRoom extends RoomTemplate {
    public MinerRoom() {   // Why is there a '...' after String?
        super("miner's room", "You are in a small room full of empty racks for tools. To the west is an incredibly dark passage, to the east an abandoned open vault door. \nThere is also a passage leading south.");
